...
Hero9.defaultProps = {
  content1:
    'Showcase your expertise and attract new clients with our specialized services',
  action1: 'Learn More',
  heading1:
    'Welcome to the Ultimate Sliding Door Repair Professionals Platform',
  image1Alt: 'Sliding Door Repair Professionals',
  action2: 'Get Started',
  image1Src:
    'https://images.unsplash.com/photo-1505210183580-5ddbc8523018?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcxODUzMTQ1MXw&ixlib=rb-4.0.3&q=80&w=1080',
}
